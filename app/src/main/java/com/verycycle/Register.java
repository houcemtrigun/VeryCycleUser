...
public class Register extends AppCompatActivity {
   ...
   /* public void showImageSelection() {
    ...
    private void updateProfile() {
        ...
        RequestBody register_id = RequestBody.create(MediaType.parse("text/plain"), "");
        RequestBody type = RequestBody.create(MediaType.parse("text/plain"), "USER");

        Call<SignupModel> signupCall = apiInterface.signupUser(f_name, l_name, email, password, register_id,type, filePart);
                ...
                try {
                    ...
                    if (data.status.equals("1")) {
                      ...
                      //  SessionManager.writeString(Register.this, Constant.USER_INFO, dataResponse);
                        Toast.makeText(Register.this, getString(R.string.sign_in_successful), Toast.LENGTH_SHORT).show();
                        finish();
                    } else if (data.status.equals("0")) {
                        Toast.makeText(Register.this, data.message, Toast.LENGTH_SHORT).show();
                    }
