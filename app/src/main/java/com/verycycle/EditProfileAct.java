...
import com.verycycle.databinding.ActivityEditProfileBinding;
...
public class EditProfileAct extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        binding.etFname.setText(DataManager.getInstance().getUserData(EditProfileAct.this).result.username);
    ...
    private void updateProfile() {
        ...
        RequestBody provider_id = RequestBody.create(MediaType.parse("text/plain"), DataManager.getInstance().getUserData(EditProfileAct.this).result.id);


        Call<SignupModel> signupCall = apiInterface.profileUpdate(f_name, email, mobile, country_code,provider_id, filePart);
