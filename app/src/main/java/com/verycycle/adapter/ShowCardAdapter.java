...
import com.verycycle.databinding.ItemCard2Binding;
...
public class ShowCardAdapter extends RecyclerView.Adapter<ShowCardAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemCard2Binding binding = DataBindingUtil.inflate(LayoutInflater.from(context),R.layout.item_card_2,parent,false);
