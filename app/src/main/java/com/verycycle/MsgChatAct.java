...
public class MsgChatAct extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initializeViews();
        if (getIntent() != null) {
            setUserInfo(getIntent().getStringExtra("DriverId"));
            receiverId = getIntent().getStringExtra("DriverId");
            receiverName = getIntent().getStringExtra("DriverName");
            receiverImage = getIntent().getStringExtra("DriverImage");
